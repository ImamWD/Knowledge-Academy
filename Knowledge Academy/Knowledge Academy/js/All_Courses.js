...
function Display()
{
    ...
    for(let i=0;i<Courses.length;i++)
    {
        ...
        <img src="imgs/courses-image/${Courses[i].Image}" style="width:100% ; margin:0px 0px ; border-top-left-radius: .75rem; border-top-right-radius: .75rem;">
        <div style="margin-top:10px ; margin-left:10px ;">
            ...
            <hr>
            <img src="imgs/teachers/avatar-5-100x100.jpg" style="width:30px; border-radius:50% ;">
