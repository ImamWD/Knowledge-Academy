...
async function sweetinputs()
{
    const { value: formValues } = await Swal.fire({
        ...
        html:  `<label style = "display:flex"> <p style="width:25%; margin-top: revert;">Name</p>  <input placeholder="Course Name" onkeyup="validation(this,0)"  type="text" id="swal-input1" class="form-control  swal2-input " style="width:80%"/></label>
                ...
                <label style = "display:flex"> <p style="width:25%; margin-top: revert;">Image</p> <input placeholder="Course Image" type="file" id="swal-input4" class="form-control swal2-input" style="width:80%"/></label>
                ...
                <label style = "display:flex"> <p style="width:25%; margin-top: revert;">Teacher</p>  <input placeholder="Course Teacher" onkeyup="validation(this,5)" type="text" id="swal-input6" class="form-control swal2-input" style="width:80%"/></label>`,
...
{
    Swal.fire({
        title :'Description for '+ Courses[index].Name + 'Course.',
